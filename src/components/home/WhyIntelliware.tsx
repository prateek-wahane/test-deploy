  ...
  const pillars = [
    {
      ...
      stat: { target: 50, suffix: '+', labelKey: 'why.enterpriseClients' },
    ...
    },
    {
      ...
      stat: { target: 500, suffix: '+', labelKey: 'why.techProfessionals' },
    ...
    },
    {
      ...
      stat: { target: 25, suffix: '+', labelKey: 'why.emeaMarkets' },
